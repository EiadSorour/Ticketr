        ...
        <div className="max-w-xl mx-auto mt-10 bg-white rounded-xl shadow-md p-8 border border-gray-100">
            ...
            {eventDetails && ticketDetails && userDetails ? (
                <>
                    ...
                    { ticketDetails.status === "valid" ?<button onClick={handleOnTicketScanned} className="mt-4 w-full bg-green-600 text-white px-6 py-3 rounded-lg font-medium hover:bg-green-700 transition-colors duration-200 shadow-md flex items-center justify-center disabled:bg-gray-400 disabled:cursor-not-allowed">
                        Scan Ticket
